...
public class SequenceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setViewPagerAdapter() {
        mSimpleViewPagerAdapterAdapter = new SimpleViewPagerAdapterAdapter(SequenceActivity.this, imageArray);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.home:
                finish();
                AnimUtil.slideFromLeftAnim(SequenceActivity.this);
                break;
            case R.id.next:
...
//        Utils.showAlertDialogWithoutIcon(this, Utils.APP_TITLE, "Return to table of contents?");
    ...
    private class Callback extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            Utils.showProgress(SequenceActivity.this, "Loading...");
        }
